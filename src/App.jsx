...
export default function TaimourAbidWebsite() {
  ...
  <span className="inline-block text-xs sm:text-sm font-medium text-gray-600 bg-gray-50 px-3 sm:px-4 py-2 rounded-full">
    Revenue Systems Architect • $100M+ Pipeline
  </span>
</div>
